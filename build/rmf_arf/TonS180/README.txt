...
yourself. The files all begin TonS180 - which is the internal name given to this
spectum. The files TonS180pc.pi and/or TonS180wt.pi are those which were
...
If you use the TonS180[wt|pc].pi files, Xspec will look for the back.pi and
