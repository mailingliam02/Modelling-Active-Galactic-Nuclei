...
yourself. The files all begin Mkn1048 - which is the internal name given to this
spectum. The files Mkn1048pc.pi and/or Mkn1048wt.pi are those which were
...
If you use the Mkn1048[wt|pc].pi files, Xspec will look for the back.pi and
