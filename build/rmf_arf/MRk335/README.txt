...
yourself. The files all begin MRk335 - which is the internal name given to this
spectum. The files MRk335pc.pi and/or MRk335wt.pi are those which were
...
If you use the MRk335[wt|pc].pi files, Xspec will look for the back.pi and
