...
yourself. The files all begin Mkn1044 - which is the internal name given to this
spectum. The files Mkn1044pc.pi and/or Mkn1044wt.pi are those which were
...
If you use the Mkn1044[wt|pc].pi files, Xspec will look for the back.pi and
